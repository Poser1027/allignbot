...
G_desti_1 = IMG2W(215.98216,146.48305)
# G_desti_2 = IMG2W(169.49669,144.5292)
Y_desti_1 = IMG2W(211.6259,233)
# Y_desti_2 = IMG2W(165.0383,233)
...
def move_block(pub_cmd, loop_rate, start_xw_yw_zw, target_xw_yw_zw, vel, accel):
    ...
    start_loc_high = lab_invk(start_xw_yw_zw[0],start_xw_yw_zw[1],start_xw_yw_zw[2]+150,0)
    end_loc = lab_invk(target_xw_yw_zw[0],target_xw_yw_zw[1],target_xw_yw_zw[2],0)
    end_loc_high = lab_invk(target_xw_yw_zw[0],target_xw_yw_zw[1],target_xw_yw_zw[2]+150,0)

    move_arm(pub_cmd, loop_rate, start_loc_high, vel, accel)
    move_arm(pub_cmd, loop_rate, start_loc, vel, accel)
    gripper(pub_cmd, loop_rate, suction_on)
    time.sleep(2)
    if (gripper_current==True):
        move_arm(pub_cmd, loop_rate, start_loc_high, vel, accel)
        move_arm(pub_cmd, loop_rate, end_loc_high, vel, accel)
...
def main():
    ...
    G_start_xw_yw_zw_1 = [xw_yw_G[0][0],xw_yw_G[0][1],30]
    # G_start_xw_yw_zw_2 = [xw_yw_G[1][0],xw_yw_G[1][1],31]
    G_target_xw_yw_zw_1 = [G_desti_1[0],G_desti_1[1],30]
    # G_target_xw_yw_zw_2 = [G_desti_2[0],G_desti_2[1],31]
    Y_start_xw_yw_zw_1 = [xw_yw_Y[0][0],xw_yw_Y[0][1],30]
    # Y_start_xw_yw_zw_2 = [xw_yw_Y[1][0],xw_yw_Y[1][1],31]
    Y_target_xw_yw_zw_1 = [Y_desti_1[0],Y_desti_1[1],30]
    # Y_target_xw_yw_zw_2 = [Y_desti_2[0],Y_desti_2[1],31]

    move_block(pub_command, loop_rate, G_start_xw_yw_zw_1, G_target_xw_yw_zw_1, vel, accel)
    # move_block(pub_command, loop_rate, G_start_xw_yw_zw_2, G_target_xw_yw_zw_2, vel, accel)
    move_block(pub_command, loop_rate, Y_start_xw_yw_zw_1, Y_target_xw_yw_zw_1, vel, accel)
    # move_block(pub_command, loop_rate, Y_start_xw_yw_zw_2, Y_target_xw_yw_zw_2, vel, accel)
